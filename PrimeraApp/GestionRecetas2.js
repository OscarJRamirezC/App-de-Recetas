...
import { crearReceta2, obtenerRecetas2, eliminarReceta2 } from './helpersFirebase';

export default function GestionRecetas2() {
  ...
  const cargarRecetas2 = async () => {
    const data = await obtenerRecetas2();
    setRecetas(data);
  };
  ...
  const handleCrear = async () => {
    ...
    await crearReceta2({ nombre, ingredientes, pasos });
    setNombre("");
    setIngredientes("");
    setPasos("");
    cargarRecetas2();
